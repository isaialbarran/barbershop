...
import BarbershopsScreenStacks from './BarbershopsStacks';
...
const NavigationStacks = createBottomTabNavigator(
  {
    Barbershops: {
      screen: BarbershopsScreenStacks,
      navigationOptions: () => ({
        tabBarLabel: 'Barberías',
  ...
  {
    initialRouteName: 'Barbershops',
    order: ['Barbershops', 'Favorites', 'TopLists', 'Search', 'Account'],
    tabBarOptions: {
